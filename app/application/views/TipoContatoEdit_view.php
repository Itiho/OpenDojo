...
<?php
    echo form_open('TipoContato/edit/'.$tipocontato['idTipoContato'],$attributes_form);
    echo form_hidden('idTipoContato',$tipocontato['idTipoContato']);
    ...
    echo form_label('Arte marcial', 'tipoContato', $attributes_label);
?>
    <div class="col-xs-4">
<?php
